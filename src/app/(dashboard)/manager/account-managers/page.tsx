...
import { toggleUserStatusAction }   from '@/lib/auth';
...
export default function AccountManagersPage() {
  ...
  const handleToggle = async (id: string, currentStatus: string) => {
    ...
    else toast.success(currentStatus === 'active' ? 'Account deactivated' : 'Account activated');
    ...
    <div className="wm-page-inner">
      ...
      {isLoading ? (
        ...
        <div className="wm-fade-up-2">
          <AMTable managers={managers} onToggle={handleToggle} isToggling={isToggling} />
        </div>
      )}
