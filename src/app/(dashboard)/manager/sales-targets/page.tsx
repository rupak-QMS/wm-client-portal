          ...
          <div style={{ position:'relative', zIndex:1, width:'100%', maxWidth:480, background:'#0e0e20', border:'1px solid rgba(124,58,237,.3)', borderRadius:18, padding:28 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              ...
              <div style={{ display:'flex', gap:10, marginTop:4 }}>
                ...
                <button className="wm-btn-primary" style={{ flex:1, height:40 }} disabled={saveMutation.isPending || !form.sales_member_id}
                  onClick={() => saveMutation.mutate(form)}>Save Target</button>
              </div>
            </div>
          </div>
        </div>
